...
CREATE TABLE faculty (
    ...
    phone         VARCHAR(15),
    designation   ENUM('Professor','Associate Professor','Assistant Professor','Lecturer') DEFAULT 'Professor',
...
CREATE TABLE classrooms (
    ...
    room_type     ENUM('Classroom','Lab','Seminar Hall') DEFAULT 'Classroom',
...
(1,2,'Data Structures and Algorithms',   'IT202',4),
(1,3,'Operating Systems',       'IT301',4),
(1,3,'Database Management Systems', 'IT302',4),
(2,2,'Basic Computer Networks',       'CS201',4),
(2,3,'Artificial Intelligence and Machine Learning', 'CS301',4),
(3,2,'Digital Electronics and Logical Design',     'EL201',4),
(1,1,'Object Oriented Programming', 'IT101',4),
(1,4,'Computer Graphics',         'IT401',4);
